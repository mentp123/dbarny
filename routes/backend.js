...
if (create) {
      ...
      // Your code for creating a table goes here
            ...
            CREATE TABLE IF NOT EXISTS bdar2fa (
    ...
    const tableName = 'bdar2fa'; // Replace with the name of the table to delete
    ...
    db.query(deleteQuery, (err, result) => {
      ...
      const query = 'SELECT * FROM bdar2fa ORDER BY date'; // Replace with your table name
